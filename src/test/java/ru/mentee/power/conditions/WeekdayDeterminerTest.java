...
class WeekdayDeterminerTest {
    ...
    @Test
    void testGetDayDescription_Thursday() {
        assertThat(WeekdayDeterminer.getDayDescription(4))
                .isEqualTo("Четверг - рабочий день");
    }
    ...
    void testGetDayDescription_InvalidDay() {
        // Проверка значений за пределами диапазона 1-7
        assertThat(WeekdayDeterminer.getDayDescription(0))
                .isEqualTo("Некорректный день недели");
        assertThat(WeekdayDeterminer.getDayDescription(8))
                .isEqualTo("Некорректный день недели");
        assertThat(WeekdayDeterminer.getDayDescription(-1))
                .isEqualTo("Некорректный день недели");
        assertThat(WeekdayDeterminer.getDayDescription(100))
                .isEqualTo("Некорректный день недели");
    }
}